...
** SET PATHS HERE
run "/Users/corinnes/Dropbox/0 Research/5_AKK_replication/Scripts/Clean_MayORG/0_Paths"
...
label var avlswt "Average labor supply share in cell over 1963 - 2019"
...
summ
desc
label data "May Predicted Wages 1979-2020: by year-gender-education-experience"

* saving
save "$data_out/Predicted_wages_1979_2020_MORG.dta", replace
...
/*
tab year [aw=avlswt], summ(plnwkw)
tab year [aw=avlswt], summ(plnhrw)

tab year [aw=avlswt], summ(rplnwkw)
tab year [aw=avlswt], summ(rplnhrw)
