/*==============================================================================
	DESCRIPTION: clean CPS-ASEC years 1988-1991
==============================================================================*/		
...
label var bcwkwg "wkwage<$40/wk in 1982$ following Katz-Murphy (1992), using GDP PCE deflator" 
...
label var bcwkwgkm "wkwage<$67/wk in 1982$ following Katz-Murphy (1992), using GDP PCE deflator" 
...
keep ed* wgt* agely exp* female year school fulltime fullyear wageworker selfemp deflator* ///
	...
	weeks_lastyear hours_lastyear inclongj oincwage educomp lnr* ftfy rwinc rhinc e1* e2* e3* e4* pt

* saving 
save "$data_out/ASEC_1988_1991_cleaned_notop.dta", replace	// this version is for Figure 1
...
* saving 
save "$data_out/ASEC_1988_1991_cleaned_top.dta", replace 
