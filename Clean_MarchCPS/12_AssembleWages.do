...
summ
desc
label data "March Predicted Wages 1964-2020: by year-gender-education-experience"

* saving
save "$data_out/Predicted_wages_1964_2020.dta", replace


* removing unneeded data files
rm "$data_out/Predicted_wages_march.dta"
