...
keep year ln_mn_wg*
gduplicates drop
keep if year==1963 | year==1971 | year==1979 | year==1987 | year==1995 | year==2005 | year==2012 | year==2019
gen diff=ln_mn_wg[_n]-ln_mn_wg[_n-1]
local new = _N + 2
set obs `new'
gen num=_n
foreach yr in 1963 2005 2019 {
	gen wage_`yr'=ln_mn_wg if year==`yr'
	sort wage_`yr'
	carryforward wage_`yr', replace
}
sort num
replace diff=wage_2005-wage_1963 if num==9
replace diff=wage_2019-wage_1963 if num==10
keep diff
...
sort num
forval i=0/1 {
	replace diff`i'=wage_2005_`i'-wage_1963_`i' if num==9
	replace diff`i'=wage_2019_`i'-wage_1963_`i' if num==10
}
keep diff*
...
sort num
forval y=1/5 {
	replace diff`y'=wage_2005_`y'-wage_1963_`y' if num==9
	replace diff`y'=wage_2019_`y'-wage_1963_`y' if num==10
}
keep diff*
...
rename v6 y2005_2012
rename v7 y2012_2019
rename v8 y1963_2005
rename v9 y1963_2019
