...
twoway ///
	...
	, ///
	ylabel(0.4(.05)0.7, labsize(small) nogrid) ///
	...
	saving("$figures/Figure8/Figure8_replication_PanelA.gph",replace)
graph export "$figures/Figure8/Figure8_replication_PanelA.pdf", replace
...
twoway ///
	...
	xtitle("") ///
	ytitle("Log 90/50 ratio", size(small)) ///	
	saving("$figures/Figure8/Figure8_replication_PanelB.gph",replace)
graph export "$figures/Figure8/Figure8_replication_PanelB.pdf", replace	
...
twoway ///
	...
	saving("$figures/Figure8/Figure8_replication_PanelC.gph",replace)
graph export "$figures/Figure8/Figure8_replication_PanelC.pdf", replace
...
twoway ///
	...
	xtitle("") ///
	ytitle("Log 50/10 ratio", size(small)) ///	
	saving("$figures/Figure8/Figure8_replication_PanelD.gph",replace)
graph export "$figures/Figure8/Figure8_replication_PanelD.pdf", replace
