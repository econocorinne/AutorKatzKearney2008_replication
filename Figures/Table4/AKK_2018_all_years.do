/*==============================================================================
						Creating simulated data: 2018 base year
==============================================================================*/		
cap log close 
clear all 
set more off
...
foreach y of numlist 1973/2017 {
	forval gender=0/1 {

	use "$data_out/MayCPS_MORG_cleaned.dta", clear
	keep if year==2018 | year==`y'
	...
	* Actual overall inequality
	...
	summ rlnhrwage if sex==`gender' & year==2018 [aw=regweight], det
	gen tot_vln_2018 = _result(4) 
	gen tot_90_2018 = _result(12)
	gen tot_50_2018 = _result(10) 
	gen tot_10_2018=  _result(8)

	gen t9010_2018 =tot_90_2018-tot_10_2018
	gen t9050_2018 =tot_90_2018-tot_50_2018
	gen t5010_2018 =tot_50_2018-tot_10_2018

	* Actual residual inequality

	/* Use TL'S (2006) conditioning set: dummies for age, years of schooling, interactions  
	between 9 schooling dummies (0-4, 5-8, 9, 10, 11, 12, 13-15, 16, 17) and a quartic in age */
	...
	quietly reg rlnhrwage `RHS_DFLx' if sex==`gender' & year==2018 [aw=regweight]
	predict reslnwage2018 if year==2018, resid
	summ reslnwage2018

	gen reslnwage = reslnwage2018 if year==2018

	summ reslnwage if sex==`gender' & year==2018 [aw=regweight], det
	gen rvln = _result(4) 
	gen r90 = _result(12)
	gen r50 = _result(10) 
	gen r10=  _result(8)

	gen r90102018 =r90-r10 
	gen r90502018 =r90-r50
	gen r50102018 =r50-r10
	...
	* Overall inequality -- simulated 
	...
	summ rlnhrwage if sex==`gender' & year==2018 [aw=DFLweight], det
	gen tvln_x`y' = _result(4) 
	gen t90_x`y' = _result(12)
	gen t50_x`y' = _result(10) 
	gen t10_x`y' =  _result(8)

	gen t9010_2018x`y' =t90_x`y'-t10_x`y'
	gen t9050_2018x`y' =t90_x`y'-t50_x`y'
	gen t5010_2018x`y' =t50_x`y'-t10_x`y'
	...
	* Simulated residual inequality
	summ reslnwage if sex==`gender' & year==2018 [aw=DFLweight], det
	gen rvln_2018x`y' = _result(4) 
	gen r90_2018x`y' = _result(12)
	gen r50_2018x`y' = _result(10) 
	gen r10_2018x`y'=  _result(8)

	gen r9010_2018x`y' =r90_2018x`y'-r10_2018x`y'
	gen r9050_2018x`y' =r90_2018x`y'-r50_2018x`y'
	gen r5010_2018x`y' =r50_2018x`y'-r10_2018x`y'
	...
	* Reduce data set
	...
	gen t9010simx = t9010_2018x`y'
	gen t9050simx = t9050_2018x`y'
	gen t5010simx = t5010_2018x`y'

	gen r9010simx = r9010_2018x`y'
	gen r9050simx = r9050_2018x`y'
	gen r5010simx = r5010_2018x`y'

	rename r90102018 r9010_2018
	rename r90502018 r9050_2018
	rename r50102018 r5010_2018
	...
	rename rvln_2018x`y' rvlnsim
	rename tot_vln_2018 tvln


	keep a_year x_year t9010simx t9050simx t5010simx r9010simx r9050simx r5010simx ///
		t9010_2018 t9050_2018 t5010_2018 r9010_2018 r9050_2018 r5010_2018 ///
		t9010x t9050x t5010x r9010x r9050x r5010x tvlnsim rvlnsim tvln rvln

	order a_year x_year t9010_2018 t9050_2018 t5010_2018 r9010_2018 r9050_2018 r5010_2018 ///
	...
	* saving
	save "$data_out/Simulated/sim-DFL-X-2018-`y'-`gender'.dta", replace	
...
forval gender=0/1 {
	...
	* Reduce data set
	...
	gen t9010simx = t9010_2018
	gen t9050simx = t9050_2018
	gen t5010simx = t5010_2018

	rename r90102018 r9010_2018
	rename r90502018 r9050_2018
	rename r50102018 r5010_2018

	gen r9010simx = r9010_2018
	gen r9050simx = r9050_2018
	gen r5010simx = r5010_2018

	gen t9010x = t9010_2018
	gen t9050x = t9050_2018
	gen t5010x = t5010_2018

	gen r9010x = r9010_2018
	gen r9050x = r9050_2018
	gen r5010x = r5010_2018

	gen tvlnsim = tot_vln_2018
	gen rvlnsim = rvln
	...
	* saving
	save "$data_out/Simulated/sim-DFL-X-2018-2018-`gender'.dta", replace	
}
...
clear
forval y=1973(1)2019 {
	forval gender=0/1 {
		use "$data_out/Simulated/sim-DFL-X-2018-`y'-`gender'.dta", clear
		gen sex=`gender'
		save "$data_out/Simulated/sim-DFL-X-2018-`y'-`gender'.dta", replace
}
}
...
forval y=1973(1)2019 {
	forval gender=0/1 {
		append using "$data_out/Simulated/sim-DFL-X-2018-`y'-`gender'.dta"
}
}

* saving
save "$data_out/Simulated/sim-DFL-X-2018-allyrs.dta", replace	
